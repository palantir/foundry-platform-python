...
def test_language_models_v2_client_access_performance():
    init_and_access_time = timeit.timeit(
        stmt="foundry_sdk.v2.FoundryClient(foundry_sdk.UserTokenAuth(token='token'), hostname='localhost').language_models",
        setup="import sys; sys.modules.pop('foundry_sdk.v2', None);import foundry_sdk; import foundry_sdk.v2",
        number=1,
    )
...
def test_language_models_v2_models_import_performance():
    init_and_access_time = timeit.timeit(
        stmt="import foundry_sdk.v2.language_models.models",
        setup="import sys; sys.modules.pop('foundry_sdk.v2.language_models.models', None)",
        number=1,
    )
