...
class StreamTimeSeriesPointsRequest(BaseModel):
    ...
    def to_dict(self) -> StreamTimeSeriesPointsRequestDict:
        """Return the dictionary representation of the model using the field aliases."""
        return cast(
            StreamTimeSeriesPointsRequestDict, self.model_dump(by_alias=True, exclude_unset=True)
        )
