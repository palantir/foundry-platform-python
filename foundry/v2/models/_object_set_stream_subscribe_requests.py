...
class ObjectSetStreamSubscribeRequests(BaseModel):
    """
    ...
    requests: List[ObjectSetStreamSubscribeRequest]

    model_config = {"extra": "allow"}

    def to_dict(self) -> ObjectSetStreamSubscribeRequestsDict:
        """Return the dictionary representation of the model using the field aliases."""
        return cast(
            ObjectSetStreamSubscribeRequestsDict, self.model_dump(by_alias=True, exclude_unset=True)
        )
