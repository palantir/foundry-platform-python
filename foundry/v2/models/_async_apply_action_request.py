...
class AsyncApplyActionRequest(BaseModel):
    ...
    def to_dict(self) -> AsyncApplyActionRequestDict:
        """Return the dictionary representation of the model using the field aliases."""
        return cast(AsyncApplyActionRequestDict, self.model_dump(by_alias=True, exclude_unset=True))
