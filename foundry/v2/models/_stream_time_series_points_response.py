...
class StreamTimeSeriesPointsResponse(BaseModel):
    ...
    def to_dict(self) -> StreamTimeSeriesPointsResponseDict:
        """Return the dictionary representation of the model using the field aliases."""
        return cast(
            StreamTimeSeriesPointsResponseDict, self.model_dump(by_alias=True, exclude_unset=True)
        )
