...
class BatchApplyActionRequestV2(BaseModel):
    ...
    options: Optional[BatchApplyActionRequestOptions] = None

    requests: List[BatchApplyActionRequestItem]

    model_config = {"extra": "allow"}

    def to_dict(self) -> BatchApplyActionRequestV2Dict:
        """Return the dictionary representation of the model using the field aliases."""
        return cast(
            BatchApplyActionRequestV2Dict, self.model_dump(by_alias=True, exclude_unset=True)
        )
