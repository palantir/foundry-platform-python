...
class GeotimeSeriesValue(BaseModel):
    ...
    def to_dict(self) -> GeotimeSeriesValueDict:
        """Return the dictionary representation of the model using the field aliases."""
        return cast(GeotimeSeriesValueDict, self.model_dump(by_alias=True, exclude_unset=True))
