...
class StsRoleConfiguration(pydantic.BaseModel):
    ...
    role_session_duration: Optional[Duration] = pydantic.Field(alias=str("roleSessionDuration"), default=None)  # type: ignore[literal-required]
    ...
    external_id: Optional[str] = pydantic.Field(alias=str("externalId"), default=None)  # type: ignore[literal-required]
    ...
    sts_endpoint: Optional[str] = pydantic.Field(alias=str("stsEndpoint"), default=None)  # type: ignore[literal-required]
    ...
    def to_dict(self) -> StsRoleConfigurationDict:
        ...
        return cast(StsRoleConfigurationDict, self.model_dump(by_alias=True, exclude_unset=True))
