...
class StsRoleConfiguration(pydantic.BaseModel):
    ...
    role_session_name: str = pydantic.Field(alias="roleSessionName")
    ...
    role_session_duration: Optional[Duration] = pydantic.Field(
        alias="roleSessionDuration", default=None
    )
    ...
    external_id: Optional[str] = pydantic.Field(alias="externalId", default=None)
    ...
    sts_endpoint: Optional[str] = pydantic.Field(alias="stsEndpoint", default=None)
