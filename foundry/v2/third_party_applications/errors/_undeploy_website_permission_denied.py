...
class UndeployWebsitePermissionDeniedParameters(TypedDict):
...
@dataclass
class UndeployWebsitePermissionDenied(PermissionDeniedError):
    name: Literal["UndeployWebsitePermissionDenied"]
    parameters: UndeployWebsitePermissionDeniedParameters
    error_instance_id: str


__all__ = ["UndeployWebsitePermissionDenied"]
