...
class ForbiddenOperationOnAutosavedResourceParameters(TypedDict):
...
@dataclass
class ForbiddenOperationOnAutosavedResource(PalantirRPCException):
    name: Literal["ForbiddenOperationOnAutosavedResource"]
