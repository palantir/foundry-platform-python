...
class FullRowChangeDataCaptureConfiguration(BaseModel):
    """
    ...
    deletion_field_name: FieldName = Field(alias="deletionFieldName")
    """The name of a boolean field in the schema that indicates whether or not a row has been deleted."""

    ordering_field_name: FieldName = Field(alias="orderingFieldName")
    """
