...
class StructFieldType(BaseModel):
    """StructFieldType"""

    sub_fields: List[Field] = Field(alias="subFields")
...
class ArrayFieldType(BaseModel):
    """ArrayFieldType"""

    items_schema: FieldSchema = Field(alias="itemsSchema")
...
class MapFieldType(BaseModel):
    """MapFieldType"""

    key_schema: FieldSchema = Field(alias="keySchema")

    value_schema: FieldSchema = Field(alias="valueSchema")
