...
class SessionExchangeResult(pydantic.BaseModel):
    ...
    Updates can only be generated for parameter values which were provided as input to the Agent, and which are configured with `READ_WRITE` access on the Agent in AIP Agent Studio.
    """
