...
class GetRagContextForSessionPermissionDeniedParameters(TypedDict):
...
@dataclass
class GetRagContextForSessionPermissionDenied(PermissionDeniedError):
    name: Literal["GetRagContextForSessionPermissionDenied"]
