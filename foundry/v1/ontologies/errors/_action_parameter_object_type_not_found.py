...
class ActionParameterObjectTypeNotFoundParameters(TypedDict):
...
@dataclass
class ActionParameterObjectTypeNotFound(PalantirRPCException):
    name: Literal["ActionParameterObjectTypeNotFound"]
    parameters: ActionParameterObjectTypeNotFoundParameters
    error_instance_id: str


__all__ = ["ActionParameterObjectTypeNotFound"]
