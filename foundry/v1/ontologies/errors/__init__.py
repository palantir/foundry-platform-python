...
from foundry.v1.ontologies.errors._duration_out_of_bounds import DurationOutOfBounds
...
from foundry.v1.ontologies.errors._invalid_derived_property_definition import (
