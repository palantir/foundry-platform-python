...
class GetMediaItemInfoResponse(pydantic.BaseModel):
    ...
    view_rid: MediaSetViewRid = pydantic.Field(alias="viewRid")

    path: Optional[MediaItemPath] = None

    logical_timestamp: LogicalTimestamp = pydantic.Field(alias="logicalTimestamp")
    ...
    def to_dict(self) -> GetMediaItemInfoResponseDict:
        ...
        return cast(
            GetMediaItemInfoResponseDict, self.model_dump(by_alias=True, exclude_unset=True)
        )
