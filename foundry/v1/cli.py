...
@mediasets.group("media_set")
def mediasets_media_set():
    pass
...
@mediasets_media_set.command("upload")
@click.argument("media_set_rid", type=str, required=True)
@click.argument("body", type=click.File("rb"), required=True)
@click.option("--branch_name", type=str, required=False, help="""branchName""")
...
@click.pass_obj
def mediasets_media_set_upload(
    client: foundry.v1.FoundryClient,
    media_set_rid: str,
    body: io.BufferedReader,
    branch_name: Optional[str],
    ...
    """
    result = client.mediasets.MediaSet.upload(
        media_set_rid=media_set_rid,
        body=body.read(),
        branch_name=branch_name,
