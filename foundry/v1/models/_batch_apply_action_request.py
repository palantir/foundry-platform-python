...
class BatchApplyActionRequest(BaseModel):
    ...
    def to_dict(self) -> BatchApplyActionRequestDict:
        """Return the dictionary representation of the model using the field aliases."""
        return cast(BatchApplyActionRequestDict, self.model_dump(by_alias=True, exclude_unset=True))
