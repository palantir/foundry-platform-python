...
class AggregationObjectTypeGrouping(BaseModel):
    """
    ...
    def to_dict(self) -> AggregationObjectTypeGroupingDict:
        """Return the dictionary representation of the model using the field aliases."""
        return cast(
            AggregationObjectTypeGroupingDict, self.model_dump(by_alias=True, exclude_unset=True)
        )
