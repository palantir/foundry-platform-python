...
class ObjectTypeWithLink(BaseModel):
    ...
    link_types: Optional[List[LinkTypeSideV2]] = Field(alias="linkTypes", default=None)

    _properties: ClassVar[Set[str]] = set(["objectType", "linkTypes"])
    ...
    @classmethod
    def from_dict(cls, obj: Dict, *, allow_extra=False) -> "ObjectTypeWithLink":
