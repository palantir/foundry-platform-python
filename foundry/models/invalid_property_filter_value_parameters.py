...
class InvalidPropertyFilterValueParameters(BaseModel):
    ...
    property_filter_value: StrictStr = Field(description="Represents the value of a property filter. For instance, false is the FilterValue in `properties.{propertyApiName}.isNull=false`. ", alias="propertyFilterValue")
    __properties: ClassVar[Set[str]] = set(("expectedType", "property", "propertyFilter", "propertyFilterValue"))
