...
class OntologyObject(BaseModel):
    ...
    properties: Optional[Optional[Dict[str, PropertyValue]]] = Field(default=None)
    ...
    _properties: ClassVar[Set[str]] = set(["properties", "rid"])
    ...
    @classmethod
    def from_dict(cls, obj: Dict, *, allow_extra=False) -> "OntologyObject":
