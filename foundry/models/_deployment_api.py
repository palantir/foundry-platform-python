...
class DeploymentApi(BaseModel):
    """DeploymentApi"""

    transform: Optional[DeploymentTransformApi] = Field(default=None)
    """DeploymentTransformApi"""

    _properties: ClassVar[Set[str]] = set(["transform"])
    ...
    @classmethod
    def from_dict(cls, obj: Dict, *, allow_extra=False) -> "DeploymentApi":
