...
class FileNotFoundOnTransactionRangeParameters(BaseModel):
    ...
    end_transaction_rid: StrictStr = Field(description="The Resource Identifier (RID) of a Transaction. Example: `ri.foundry.main.transaction.0a0207cb-26b7-415b-bc80-66a3aa3933f4`. ", alias="endTransactionRid")
    ...
    start_transaction_rid: Optional[StrictStr] = Field(default=None, description="The Resource Identifier (RID) of a Transaction. Example: `ri.foundry.main.transaction.0a0207cb-26b7-415b-bc80-66a3aa3933f4`. ", alias="startTransactionRid")
    __properties: ClassVar[Set[str]] = set(("datasetRid", "endTransactionRid", "path", "startTransactionRid"))
