...
class ObjectTypeV2(BaseModel):
    ...
    primary_key: StrictStr = Field(description="The name of the property in the API. To find the API name for your property, use the `Get object type` endpoint or check the **Ontology Manager**. ", alias="primaryKey")
    properties: Optional[Dict[str, PropertyV2]] = Field(default=None, description="A map of the properties of the object type.")
