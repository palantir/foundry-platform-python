...
class ListDeploymentsResponse(BaseModel):
    ...
    deployments: Optional[List[DeploymentListing]] = Field(default=None)

    _properties: ClassVar[Set[str]] = set(["deployments"])
    ...
    @classmethod
    def from_dict(cls, obj: Dict, *, allow_extra=False) -> "ListDeploymentsResponse":
