...
OntologyObjectArrayType.model_rebuild(raise_errors=False)


"""
A union of all the types supported by Ontology Object properties. 
"""
ObjectPropertyType = Annotated[Union[AttachmentType, BooleanType, ByteType, DateType, DecimalType, DoubleType, FloatType, GeoPointType, GeoShapeType, IntegerType, LongType, OntologyObjectArrayType, ShortType, StringType, TimeseriesType, TimestampType], Field(discriminator="type")]
...
object.__setattr__(ObjectPropertyType, "type_adapter", TypeAdapter(ObjectPropertyType))
