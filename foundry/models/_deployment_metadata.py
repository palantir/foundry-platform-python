...
class DeploymentMetadata(BaseModel):
    ...
    api_name: DeploymentApiName = Field(alias="apiName")
    """DeploymentApiName"""

    description: Optional[DeploymentDescription] = Field(default=None)
    """A description or explanation of what this model deployment does and is intended to be used for."""

    api: DeploymentApi = Field()
    """DeploymentApi"""

    _properties: ClassVar[Set[str]] = set(["apiName", "description", "api"])
    ...
    @classmethod
    def from_dict(cls, obj: Dict, *, allow_extra=False) -> "DeploymentMetadata":
