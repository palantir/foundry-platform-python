...
class OneOf(BaseModel):
    ...
    options: Optional[List[ParameterOption]] = Field(default=None)
    ...
    type: Literal["oneOf"] = Field()

    _properties: ClassVar[Set[str]] = set(["options", "otherValuesAllowed", "type"])
    ...
    @classmethod
    def from_dict(cls, obj: Dict, *, allow_extra=False) -> "OneOf":
