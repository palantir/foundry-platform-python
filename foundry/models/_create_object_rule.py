...
class CreateObjectRule(BaseModel):
    """CreateObjectRule"""
    ...
    type: Literal["createObject"] = Field()

    _properties: ClassVar[Set[str]] = set(["objectTypeApiName", "type"])
    ...
    @classmethod
    def from_dict(cls, obj: Dict, *, allow_extra=False) -> "CreateObjectRule":
