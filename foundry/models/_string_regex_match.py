...
class StringRegexMatch(BaseModel):
    ...
    type: Literal["stringRegexMatch"] = Field()

    _properties: ClassVar[Set[str]] = set(["regex", "configuredFailureMessage", "type"])
    ...
    @classmethod
    def from_dict(cls, obj: Dict, *, allow_extra=False) -> "StringRegexMatch":
