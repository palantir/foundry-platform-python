...
class OntologyV2(BaseModel):
    ...
    rid: StrictStr = Field(description="The unique Resource Identifier (RID) of the Ontology. To look up your Ontology RID, please use the `List ontologies` endpoint or check the **Ontology Manager**. ")
    __properties: ClassVar[Set[str]] = set(("apiName", "description", "displayName", "rid"))
