...
class AggregateObjectsResponse(BaseModel):
    ...
    data: Optional[List[AggregateObjectsResponseItem]] = Field(default=None)

    _properties: ClassVar[Set[str]] = set(["excludedItems", "nextPageToken", "data"])
    ...
    @classmethod
    def from_dict(cls, obj: Dict, *, allow_extra=False) -> "AggregateObjectsResponse":
