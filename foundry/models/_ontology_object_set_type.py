...
class OntologyObjectSetType(BaseModel):
    ...
    type: Literal["objectSet"] = Field()

    _properties: ClassVar[Set[str]] = set(["objectApiName", "objectTypeApiName", "type"])
    ...
    @classmethod
    def from_dict(cls, obj: Dict, *, allow_extra=False) -> "OntologyObjectSetType":
