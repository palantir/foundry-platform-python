...
class WebsiteDeployment(BaseModel):
    ...
    subdomains: List[WebsiteDeploymentSubdomain]

    model_config = {"extra": "allow"}

    def to_dict(self) -> WebsiteDeploymentDict:
        """Return the dictionary representation of the model using the field aliases."""
        return cast(WebsiteDeploymentDict, self.model_dump(by_alias=True, exclude_unset=True))
