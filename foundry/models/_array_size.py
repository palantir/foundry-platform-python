...
class ArraySize(BaseModel):
    """The parameter expects an array of values and the size of the array must fall within the defined range."""

    lt: Optional[Any] = Field(default=None)
    """Less than"""

    lte: Optional[Any] = Field(default=None)
    """Less than or equal"""

    gt: Optional[Any] = Field(default=None)
    """Greater than"""

    gte: Optional[Any] = Field(default=None)
    """Greater than or equal"""

    type: Literal["arraySize"] = Field()

    _properties: ClassVar[Set[str]] = set(["lt", "lte", "gt", "gte", "type"])
    ...
    @classmethod
    def from_dict(cls, obj: Dict, *, allow_extra=False) -> "ArraySize":
