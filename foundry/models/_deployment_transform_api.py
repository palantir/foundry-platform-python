...
class DeploymentTransformApi(BaseModel):
    ...
    inputs: Optional[List[ModelApiDataType]] = Field(default=None)

    outputs: Optional[List[ModelApiDataType]] = Field(default=None)

    _properties: ClassVar[Set[str]] = set(["inputs", "outputs"])
    ...
    @classmethod
    def from_dict(cls, obj: Dict, *, allow_extra=False) -> "DeploymentTransformApi":
