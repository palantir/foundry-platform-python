...
class LinkedObjectNotFoundParameters(BaseModel):
    ...
    """ # noqa: E501
    link_type: StrictStr = Field(description="The name of the link type in the API. To find the API name for your Link Type, check the **Ontology Manager** application. ", alias="linkType")
    linked_object_primary_key: Optional[Dict[str, Any]] = Field(default=None, alias="linkedObjectPrimaryKey")
    linked_object_type: StrictStr = Field(description="The name of the object type in the API in camelCase format. To find the API name for your Object Type, use the `List object types` endpoint or check the **Ontology Manager**. ", alias="linkedObjectType")
    __properties: ClassVar[Set[str]] = set(("linkType", "linkedObjectPrimaryKey", "linkedObjectType"))
