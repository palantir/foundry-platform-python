...
class ListOntologiesV2Response(BaseModel):
    """ListOntologiesV2Response"""

    data: Optional[List[OntologyV2]] = Field(default=None)
    """The list of Ontologies the user has access to."""

    _properties: ClassVar[Set[str]] = set(["data"])
    ...
    @classmethod
    def from_dict(cls, obj: Dict, *, allow_extra=False) -> "ListOntologiesV2Response":
