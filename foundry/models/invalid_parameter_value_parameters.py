...
class InvalidParameterValueParameters(BaseModel):
    ...
    __properties: ClassVar[Set[str]] = set(("parameterBaseType", "parameterDataType", "parameterId", "parameterValue"))
