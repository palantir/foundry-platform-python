...
class EndpointsClient:
    """
    The API client for the Endpoints Namespace.
...
class AsyncEndpointsClient:
    """
    The Async API client for the Endpoints Namespace.
    ...
    def __init__(
        ...
        from foundry_sdk.v3.endpoints.endpoint_set import AsyncEndpointSetClient

        self.EndpointSet = AsyncEndpointSetClient(auth=auth, hostname=hostname, config=config)
