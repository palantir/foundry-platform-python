...
class QueryClient:
    ...
    def execute(
        ...
        *,
        ...
        :param scenario_rid: The resource identifier of an ontology scenario to execute the query on.
        ...
        :param version: The semantic version range of the Query to execute. Function execution selects a satisfying version from this range. If not specified, the version most recently published is used.
