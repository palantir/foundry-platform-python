...
class AuditClient:
    """
    The API client for the Audit Namespace.
...
class AsyncAuditClient:
    """
    The Async API client for the Audit Namespace.
    ...
    def __init__(
        ...
        from foundry_sdk.v2.audit.organization import AsyncOrganizationClient
