...
AudioEncodeFormat = core.resolve_forward_references(AudioEncodeFormat, globalns=globals(), localns=locals())
AudioOperation = core.resolve_forward_references(AudioOperation, globalns=globals(), localns=locals())
AudioToTextOperation = core.resolve_forward_references(AudioToTextOperation, globalns=globals(), localns=locals())
ContrastType = core.resolve_forward_references(ContrastType, globalns=globals(), localns=locals())
DocumentToDocumentOperation = core.resolve_forward_references(DocumentToDocumentOperation, globalns=globals(), localns=locals())
DocumentToImageOperation = core.resolve_forward_references(DocumentToImageOperation, globalns=globals(), localns=locals())
DocumentToTextOperation = core.resolve_forward_references(DocumentToTextOperation, globalns=globals(), localns=locals())
ImageOperation = core.resolve_forward_references(ImageOperation, globalns=globals(), localns=locals())
ImageRegionPolygon = core.resolve_forward_references(ImageRegionPolygon, globalns=globals(), localns=locals())
ImageToTextOperation = core.resolve_forward_references(ImageToTextOperation, globalns=globals(), localns=locals())
ImageryEncodeFormat = core.resolve_forward_references(ImageryEncodeFormat, globalns=globals(), localns=locals())
MailboxOrGroup = core.resolve_forward_references(MailboxOrGroup, globalns=globals(), localns=locals())
MediaItemMetadata = core.resolve_forward_references(MediaItemMetadata, globalns=globals(), localns=locals())
OcrLanguageOrScript = core.resolve_forward_references(OcrLanguageOrScript, globalns=globals(), localns=locals())
OcrOutputFormat = core.resolve_forward_references(OcrOutputFormat, globalns=globals(), localns=locals())
TrackedTransformationResponse = core.resolve_forward_references(TrackedTransformationResponse, globalns=globals(), localns=locals())
TransactionPolicy = core.resolve_forward_references(TransactionPolicy, globalns=globals(), localns=locals())
TranscribeTextEncodeFormat = core.resolve_forward_references(TranscribeTextEncodeFormat, globalns=globals(), localns=locals())
Transformation = core.resolve_forward_references(Transformation, globalns=globals(), localns=locals())
VideoEncodeFormat = core.resolve_forward_references(VideoEncodeFormat, globalns=globals(), localns=locals())
VideoOperation = core.resolve_forward_references(VideoOperation, globalns=globals(), localns=locals())
VideoToImageOperation = core.resolve_forward_references(VideoToImageOperation, globalns=globals(), localns=locals())
VlmPreprocessingConfig = core.resolve_forward_references(VlmPreprocessingConfig, globalns=globals(), localns=locals())
