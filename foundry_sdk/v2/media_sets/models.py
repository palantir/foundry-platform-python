...
MailboxOrGroup = core.resolve_forward_references(
    MailboxOrGroup, globalns=globals(), localns=locals()
)
MediaItemMetadata = core.resolve_forward_references(
    MediaItemMetadata, globalns=globals(), localns=locals()
)
TrackedTransformationResponse = core.resolve_forward_references(
