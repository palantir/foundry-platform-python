            ...
            core.RequestInfo(
                ...
                body_type=typing_extensions.TypedDict(
                    ...
                    {  # type: ignore
                        "messages": typing.List[language_models_models.AnthropicMessage],
                        "maxTokens": int,
                        "stopSequences": typing.Optional[typing.List[str]],
                        "system": typing.Optional[
                            typing.List[language_models_models.AnthropicSystemMessage]
                        ],
                        "temperature": typing.Optional[float],
                        "thinking": typing.Optional[language_models_models.AnthropicThinkingConfig],
                        "toolChoice": typing.Optional[language_models_models.AnthropicToolChoice],
                        "tools": typing.Optional[typing.List[language_models_models.AnthropicTool]],
                        "topK": typing.Optional[int],
