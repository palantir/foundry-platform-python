...
class WidgetsClient:
    """
    The API client for the Widgets Namespace.
...
class AsyncWidgetsClient:
    """
    The Async API client for the Widgets Namespace.
