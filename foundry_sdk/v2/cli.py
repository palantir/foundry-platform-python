...
@admin_cbac_banner.command("get_for_resources")
@click.option(
    "--resource_rids",
    type=str,
    required=True,
    help="""Resource RIDs to include. The caller must have access to every resource.""",
)
@click.option(
    "--display_type",
    type=click.Choice(["BANNER_LINE", "PORTION_MARKING"]),
...
@click.pass_obj
def admin_cbac_banner_op_get_for_resources(
    client: FoundryClient,
    resource_rids: str,
    display_type: typing.Optional[typing.Literal["BANNER_LINE", "PORTION_MARKING"]],
    preview: typing.Optional[bool],
    ...
    """
    result = client.admin.CbacBanner.get_for_resources(
        resource_rids=json.loads(resource_rids),
        display_type=display_type,
        preview=preview,
    )
    click.echo(repr(result))
