...
| ------------ | ------------- | ------------- | ------------- |
**configured_failure_message** | typing.Optional[str] | No | The message indicating one of the **submission criteria** was not satisfied. This is configured per **submission criteria** in the **Ontology Manager**.  |
