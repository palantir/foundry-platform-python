...
**selected_interface_property_types** | List[InterfacePropertyApiName] | Yes | A list of interface property type API names of the interface type that should be included in the response.  Omit this parameter to include all properties of the interface type in the response.  |
