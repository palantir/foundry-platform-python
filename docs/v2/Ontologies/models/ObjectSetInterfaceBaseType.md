...
**include_all_base_object_properties** | typing.Optional[bool] | No | A flag that will return all of the underlying object properties for the objects that implement the interface.  This includes properties that don't explicitly implement an SPT on the interface.  |
