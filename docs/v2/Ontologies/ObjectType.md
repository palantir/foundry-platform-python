...
try:
    api_response = client.ontologies.Ontology.ObjectType.list_scenario_edited_entity_types(
        ontology, scenario_rid
    )
    print("The list_scenario_edited_entity_types response:\n")
    pprint(api_response)
except foundry_sdk.PalantirRPCException as e:
    print("HTTP error when calling ObjectType.list_scenario_edited_entity_types: %s\n" % e)
...
try:
    api_response = client.ontologies.Ontology.ObjectType.list_scenario_edited_link_types(
        ontology, scenario_rid, object_type
    )
    print("The list_scenario_edited_link_types response:\n")
    pprint(api_response)
except foundry_sdk.PalantirRPCException as e:
    print("HTTP error when calling ObjectType.list_scenario_edited_link_types: %s\n" % e)
...
try:
    for object_type in client.ontologies.Ontology.ObjectType.list_scenario_edited_links(
        ontology, scenario_rid, object_type, link_type, page_size=page_size, page_token=page_token
    ):
        pprint(object_type)
except foundry_sdk.PalantirRPCException as e:
    print("HTTP error when calling ObjectType.list_scenario_edited_links: %s\n" % e)
...
try:
    api_response = client.ontologies.Ontology.ObjectType.list_scenario_edited_object_types(
        ontology, scenario_rid
    )
    print("The list_scenario_edited_object_types response:\n")
    pprint(api_response)
except foundry_sdk.PalantirRPCException as e:
    print("HTTP error when calling ObjectType.list_scenario_edited_object_types: %s\n" % e)
...
try:
    for object_type in client.ontologies.Ontology.ObjectType.list_scenario_edited_objects(
        ontology, scenario_rid, object_type, page_size=page_size, page_token=page_token
    ):
        pprint(object_type)
except foundry_sdk.PalantirRPCException as e:
    print("HTTP error when calling ObjectType.list_scenario_edited_objects: %s\n" % e)
