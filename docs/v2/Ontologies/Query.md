...
**version** | Optional[FunctionVersion] | The semantic version range of the Query to execute. Function execution selects a satisfying version from this range. If not specified, the version most recently published is used.  | [optional] |
...
transaction_id = None
# Optional[FunctionVersion] | The semantic version range of the Query to execute. Function execution selects a satisfying version from this range. If not specified, the version most recently published is used.
version = None
