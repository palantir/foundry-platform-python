...
**agent_version_string** | str | The semantic version of the Agent, formatted as "majorVersion.minorVersion". |  |
...
# str | The semantic version of the Agent, formatted as "majorVersion.minorVersion".
