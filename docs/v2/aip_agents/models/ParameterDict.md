...
**description** | NotRequired[pydantic.StrictStr] | No | A description to explain the use of this parameter. This description is injected with the parameter value into the Agent's prompt, to provide context for when to use the parameter.  |
