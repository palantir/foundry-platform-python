...
**buildRid** | RID | Yes | The RID of the Build that the Job belongs to. |
**startedTime** | datetime | Yes | The time this job started waiting for the dependencies to be resolved. |
