...
| Class | Value
| ------------ | -------------
CreateConnectionRequestDirectConnectionRuntime | directConnectionRuntime
CreateConnectionRequestAgentProxyRuntime | agentProxyRuntime
CreateConnectionRequestAgentWorkerRuntime | agentWorkerRuntime
