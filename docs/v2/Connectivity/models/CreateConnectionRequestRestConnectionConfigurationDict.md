...
| ------------ | ------------- | ------------- | ------------- |
**additionalSecrets** | CreateConnectionRequestRestConnectionAdditionalSecretsDict | Yes | Additional secrets that can be referenced in code and webhook configurations. |
