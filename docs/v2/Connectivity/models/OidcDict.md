...
**issuerUrl** | str | Yes | The URL that identifies Foundry as an OIDC identity provider. |
**subject** | RID | Yes | The RID of the Connection that is connecting to the external system. |
